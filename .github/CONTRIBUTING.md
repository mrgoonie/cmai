...
# Contributing to prepare-commit-msg-cc-ai
...
- [Contributing to prepare-commit-msg-cc-ai](#contributing-to-prepare-commit-msg-cc-ai)
...
[prepare-commit-msg-cc-ai Code of Conduct](https://github.com/partcad/prepare-commit-msg-cc-ai/blob//CODE_OF_CONDUCT.md).
By participating, you are expected to uphold this code. Please report unacceptable behavior to <security@partcad.org>.

## I Have a Question

> If you want to ask a question, we assume that you have read the available
> [Documentation](https://github.com/partcad/prepare-commit-msg-cc-ai).

Before you ask a question, it is best to search for existing
[Issues](https://github.com/partcad/prepare-commit-msg-cc-ai/issues) that might help you. In case you have found a
...
- Open an [Issue](https://github.com/partcad/prepare-commit-msg-cc-ai/issues/new).
...
- Determine if your bug is really a bug and not an error on your side e.g. using incompatible environment
  ...
  [documentation](https://github.com/partcad/prepare-commit-msg-cc-ai). If you are looking for support, you might want
...
- To see if other users have experienced (and potentially already solved) the same issue you are having, check if there
  ...
  [bug tracker](https://github.com/partcad/prepare-commit-msg-cc-ai/issues?q=label%3Abug).
...
> tracker, or elsewhere in public. Instead sensitive bugs must be sent by email to <security@partcad.org>.

<!-- You may add a PGP key to allow the messages to be sent encrypted as well. -->

We use GitHub issues to track bugs and errors. If you run into an issue with the project:

- Open an [Issue](https://github.com/partcad/prepare-commit-msg-cc-ai/issues/new). (Since we can't be sure at this point
...
This section guides you through submitting an enhancement suggestion for prepare-commit-msg-cc-ai, **including
...
- Make sure that you are using the latest version.
- Read the [documentation](https://github.com/partcad/prepare-commit-msg-cc-ai) carefully and find out if the
  functionality is already covered, maybe by an individual configuration.
- Perform a [search](https://github.com/partcad/prepare-commit-msg-cc-ai/issues) to see if the enhancement has already
...
Enhancement suggestions are tracked as [GitHub issues](https://github.com/partcad/prepare-commit-msg-cc-ai/issues).
...
- **Explain why this enhancement would be useful** to most prepare-commit-msg-cc-ai users. You may also want to point
